...
Status ObjectOwnPropertiesVisitor::ProcessReceiver(
  ...
  // std::cout << "minnie " << receiver << std::endl;
...
//             prev->GetProperties()));
//   } else {
//     Handle<HashTable> old_table = GetTable();
//     Handle<HashTable> new_table = HashTable::Put(
//         old_table,
//         target_literal,
...
//           HashTable::New(isolate_, INITIAL_OBJECT_PROPERTY_MAP_SIZE),
//           isolate_));
// }
...
// v8::internal::Handle<v8::internal::HashTable>
// ObjectPropertySymbolicStateManager::GetTable() {
//   return Handle<HashTable>::cast(weak_object_map_->Get());
// }
