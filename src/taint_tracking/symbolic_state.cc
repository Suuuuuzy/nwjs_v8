...
//     return Run(obj, HashTable::New(obj->GetIsolate(), INITIAL_SIZE));
//   }

// private:
//   Handle<Object> Run(
//       Handle<JSObject> obj,
//       v8::internal::Handle<HashTable> recursion_guard) {
...
//     recursion_guard_ = HashTable::Put(
...
//   int depth_;
//   v8::internal::Handle<HashTable> recursion_guard_;
